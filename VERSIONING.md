...
## V0.17 Release Record

**Version:** V0.17  
**Category:** Odd / Backend, CMS, Security & AI  
**Name:** CMS Platform

Primary goals:

- mature Company News CMS
- server-only Supabase service-role architecture
- keep RLS enabled
- draft / publish / archive workflow
- revision snapshots
- CMS search and preview
- AI-assisted Japanese and English news drafts
- preserve V0.16 public website and three-language UI

V0.17 is intentionally an odd release because the main work is functional architecture rather than public-page visual design.


---

## V0.18 Release Record

**Version:** V0.18  
**Category:** Even / Frontend, Workspace UX & Information Architecture  
**Name:** Blue Whale OS

Primary goals:

- redesign `/workspace` as a persistent operating console
- make Company News a first-class sidebar module
- unify Projects, Suppliers, RFQ and Inquiries UI
- add an operational dashboard
- retain V0.17 CMS/security architecture
- retain V0.1 sourcing database/API compatibility
- present internal AI Copilot as a dedicated OS module
...
**Version:** V0.20  
**Category:** Even / Platform UI, Mobile & Architecture Foundation  
**Name:** Platform Foundation

Primary goals:

- fix published-news visibility
- decouple database access
- decouple AI provider access
- support DeepSeek for the public AI Concierge
- improve mobile behavior
- add health diagnostics
- preserve the current single Next.js deployment while creating clean service boundaries

V0.20 intentionally avoids a monorepo migration. The codebase is separated by service boundaries first, reducing upgrade risk.
